-- SQL Migración: Agregar campos de control a ServiciosExtraOrden
...
-- Actualizar registros nulos a PENDIENTE
EXEC('UPDATE [dbo].[ServiciosExtraOrden] SET [Estado] = ''PENDIENTE'' WHERE [Estado] IS NULL');
GO
