...
const tables = [
    "ImputacionPago", "TransaccionDetalle", "AjustesDocumento",
    "TransaccionesCaja", "EgresosCaja", "AutorizacionesSinPago",
    "MovimientosCuenta", "DeudaDocumento", "PlanesMetros",
    "CiclosCredito", "DocumentosContables", "DocumentosContablesDetalle",
    "SesionesTurno", "Cont_AsientosDetalle", "Cont_AsientosCabecera",
    "ColaEstadosCuenta", "CuentasCliente", "SecuenciaDocumentos"
];
...
async function main() {
    ...
    fs.writeFileSync('create_tables.sql', outSql, 'utf8');
    console.log("Written to create_tables.sql");
    process.exit(0);
}
