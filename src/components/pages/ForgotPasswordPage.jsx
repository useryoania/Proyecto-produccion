    ...
    return (
        <div className="flex flex-col min-h-screen bg-custom-dark relative overflow-x-hidden font-sans pt-[85px] pb-[85px]">
            ...
            <div className="flex-1 flex items-center justify-center p-4 z-10 w-full">
                {/* Wrapper exterior: gradiente animado para todos los tamaños */}
                <div className="relative w-full max-w-sm z-10 rounded-3xl p-[2px] login-gradient-border shadow-2xl shadow-black/50">
                    {/* Contenedor interior oscuro */}
                    <div className="overflow-hidden" style={{ background: '#19181B', borderRadius: 22, padding: '32px 28px' }}>
