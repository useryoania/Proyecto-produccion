...
export const HelpDeskAdminView = () => {
    ...
    useEffect(() => {
        ...
        fetchTickets();
        const interval = setInterval(() => fetchTickets(), 60000); // 1-minute polling inbox
                    ...
                    {displayTickets.map(t => (
                        <div 
                            ...
                            className={`p-3 rounded-xl border transition-all cursor-pointer ${
                                selectedTicketId === t.TicIdTicket 
...
const TicketAdminInterface = ({ ticketId, onUpdate, departamentos }) => {
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            const res = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:5000/api'}/tickets/${ticketId}/responder`, {
                method: 'POST',
